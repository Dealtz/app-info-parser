...
const iTunesMetadataPlistName = new RegExp('itunesmetadata.plist', 'g');
...
class IpaParser extends Zip {
  ...
  parse () {
    return new Promise((resolve, reject) => {
      this.getEntries([PlistName, ProvisionName, iTunesMetadataPlistName]).then(buffers => {
        ...
        const iTunesMetadataPlistInfo = this._parsePlist(buffers[iTunesMetadataPlistName]);
        plistInfo.iTunesMetadataPlistInfo = iTunesMetadataPlistInfo;
